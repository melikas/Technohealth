          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-2.5 rounded-lg border border-slate-300 focus:border-[#087A9C] focus:outline-none focus:ring-2 focus:ring-[#087A9C]/20 transition-all text-sm"
                    required
                    disabled={loading}
                  />
                </div>
              ...
              {isSignUp && (
                <label className="flex items-start gap-3 text-xs text-slate-600 leading-relaxed cursor-pointer">
                  ...
                  <span>
                    ...
                    <Link to="/terms" className="text-[#055A73] font-semibold hover:underline">
                      Terms of Use
                    </Link>{' '}
                    and acknowledge the{' '}
                    <Link to="/privacy" className="text-[#055A73] font-semibold hover:underline">
                      Privacy Policy
                    </Link>
                    .
                  </span>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 bg-[#087A9C] hover:bg-[#066580] text-white font-bold rounded-lg hover:shadow-lg hover:shadow-[#087A9C]/30 transition-all mt-6 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="mt-6 text-center">
              <p className="text-slate-600 text-sm">
                ...
                <button
                  ...
                  className="text-[#087A9C] font-semibold hover:text-[#055A73] transition-colors"
                  disabled={loading}
                >
            ...
            <div className="mt-8 pt-6 border-t border-slate-200">
              <p className="text-xs text-slate-500 text-center">
                ...
                <Link to="/terms" className="text-[#055A73] hover:underline">
                  Terms of Use
                </Link>{' '}
                and{' '}
                <Link to="/privacy" className="text-[#055A73] hover:underline">
                  Privacy Policy
                </Link>
                .
              </p>
