      ...
      <main>
          ...
          <div className="max-w-6xl mx-auto flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm rounded-full border border-[#ddd] outline-none focus:border-[#087A9C]"
              />
            </div>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-6 pb-24">
          <div className="max-w-3xl mx-auto text-center rounded-2xl border border-[#e6e6e6] bg-[#fafafa] px-6 py-12">
            ...
            <Link
              to="/schedule-demo"
              className="inline-flex px-6 py-2.5 rounded-full bg-[#087A9C] text-white text-sm font-medium no-underline hover:bg-[#066580]"
            >
              Book a demo
            </Link>
          </div>
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl border border-[#e6e6e6] shadow-xl p-6 max-h-[85vh] overflow-y-auto">
            ...
            <ul className="space-y-2 mb-6">
              {selected.data.map((item) => (
                <li
                  key={item}
                  className="text-sm text-[#333] flex items-center gap-2 before:content-[''] before:w-1.5 before:h-1.5 before:rounded-full before:bg-[#087A9C] before:shrink-0"
                >
                  {item}
                </li>
              ))}
