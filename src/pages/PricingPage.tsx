        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-24 bg-gradient-to-r from-cyan-600 to-blue-700 rounded-2xl p-12 text-center text-white">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Link to="/schedule-demo" className="bg-white text-cyan-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition">
                Start Free Trial
              </Link>
              <Link to="/schedule-demo" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition">
                Schedule Demo
              </Link>
            </div>
          </div>
