...
const siteCopy = {
  en: {
    ...
    metric2Desc: 'With MCP for agent ready health workflows.',
    metric3Title: 'AIOps Platform',
  ...
  fr: {
    ...
    metric2Desc: 'Avec MCP pour des workflows santé prêts pour les agents.',
    metric3Title: 'Plateforme AIOps',
