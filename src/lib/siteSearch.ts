...
const PAGE_RESULTS: SiteSearchResult[] = [
  ...
  },
  {
    id: 'solutions',
    label: 'Solutions',
    description: 'Customer segments TechnoHealth builds for',
    to: '/solutions',
    keywords: ['solutions', 'segments', 'use cases', 'customers'],
  },
  {
    id: 'seg-digital',
    label: 'Digital Health & RPM',
    description: 'Patient-generated data in your care workflow',
    to: '/solutions/digital-health',
    keywords: ['rpm', 'digital health', 'remote', 'patient monitoring', 'clinical'],
  },
  {
    id: 'seg-research',
    label: 'Research Organizations',
    description: 'Analysis-ready wearable study data',
  ...
  },
  {
    ...
    to: '/solutions/pharma',
    keywords: ['pharma', 'trial', 'endpoint', 'clinical study'],
  },
  {
    id: 'seg-sports',
    label: 'Sports & Performance',
    description: 'One performance view for every athlete',
    to: '/solutions/sports',
    keywords: ['sports', 'athlete', 'performance', 'coach', 'recovery'],
  },
  {
    id: 'seg-insurers',
    label: 'Health & Life Insurers',
    description: 'Wearable-enabled prevention programs',
    to: '/solutions/insurers',
    keywords: ['insurance', 'insurer', 'wellness', 'member'],
  },
  {
    id: 'seg-gamification',
    label: 'Gamification & Challenges',
    description: 'Challenges with the wearable users already own',
    to: '/solutions/gamification',
    keywords: ['gamification', 'challenge', 'leaderboard', 'fitness app'],
  },
  {
    id: 'terms',
    label: 'Terms of Use',
