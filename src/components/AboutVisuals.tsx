  ...
  return (
    <div className="w-full overflow-hidden rounded-2xl border px-4 py-8 sm:px-8 sm:py-10"
      style={{
        ...
        background:
          'linear-gradient(135deg, #E1F5FA 0%, #FFFFFF 45%, #F8F9FA 100%)',
      }}
    >
    ...
    <div className="grid md:grid-cols-2 gap-4">
      <div className="rounded-xl border p-5" style={{ borderColor: 'var(--color-border)', backgroundColor: '#FFF8F6' }}>
        ...
        <div className="space-y-3 font-mono text-[11px]" style={{ color: 'var(--color-text-secondary)' }}>
          ...
          <div className="flex gap-1 items-center flex-wrap">
            <span className="h-2 w-12 rounded-sm bg-[#81AFBC] opacity-50" />
            <span className="h-2 w-7 rounded-sm bg-[#81AFBC]" />
        ...
        <div className="space-y-3">
          {['Sleep', 'HR', 'Steps', 'Recovery'].map((label, i) => (
            <div key={label} className="flex items-center gap-3">
              ...
              <div className="flex-1 h-2.5 rounded-full overflow-hidden" style={{ backgroundColor: 'rgba(91,154,173,0.12)' }}>
                <div
...
export function RoutineVisual() {
  ...
  const bands = [
    { name: 'Sleep', color: '#005274', pattern: [0.7, 0.72, 0.68, 0.5, 0.45, 0.75, 0.78] },
    { name: 'Activity', color: '#5B9AAD', pattern: [0.55, 0.6, 0.58, 0.35, 0.3, 0.65, 0.5] },
    { name: 'Mobility', color: '#81AFBC', pattern: [0.4, 0.42, 0.45, 0.25, 0.22, 0.5, 0.48] },
  ...
  return (
    <div className="grid md:grid-cols-2 gap-4">
      ...
      <div className="rounded-xl border p-5" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-surface)' }}>
        ...
        <svg viewBox="0 0 200 80" className="w-full h-20" aria-hidden>
          <polyline fill="none" stroke="#5B9AAD" strokeWidth="2.5" points="0,35 50,32 90,38" />
          ...
          <polyline fill="none" stroke="#5B9AAD" strokeWidth="2.5" points="140,36 170,34 200,38" />
